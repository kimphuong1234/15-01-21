...
namespace MISA.CukCuk.Api.Api
{
    ...
    public class CustomersController : EntityController<Customer>
    {
        ...
        public IActionResult Post([FromBody] Customer customer)
        {
            ...
            var result = _dbConnector.Insert<Customer>(customer);
            return Ok(result);
        }
        #endregion
        ...
        //    //Dữ liệu vào database
        //    var customers = _dbConnection.Execute("Proc_UpdateCustomer", commandType: CommandType.StoredProcedure, param: dynamicParameters);
        ...
        //    var _dbConnection = new MySqlConnection();
        //    //Dữ liệu từ database
        //    var customers = _dbConnection.Execute($"DELETE FROM Customer WHERE CustomerId ='{customerId.ToString()}'");
