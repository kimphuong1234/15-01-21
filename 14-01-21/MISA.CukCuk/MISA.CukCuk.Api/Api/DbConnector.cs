...
namespace MISA.CukCuk.Api.Api
{
    ...
    //{
    //    //Dữ liệu từ database
    //    var customerGroups = _dbConnection.Query<CustomerGroup>($"SELECT * FROM CustomerGroup WHERE CustomerGroupId = '{id.ToString()}'").FirstOrDefault();
    //    //Trả dữ liệu cho Client:
    //    return Ok(customerGroups);
    //}
    ...
    {
       // var _dbConnection = new MySqlConnection(); mày khởi tạo 2 lần cái này bảo sao nó lỗi
